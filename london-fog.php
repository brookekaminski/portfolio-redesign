...
?>
    <main id="content" class="content">
        <article class="project-desc">
            ...
            <section> <span class="bold tools"> HTML | SCSS | jQuery | Git | Illustrator </span>
                <div class="clear"></div>
...
-->
            <a class="button" href="https://github.com/brookekaminski/responsive" target="_blank">View Code<span class="screen-reader-text"> external link to portfolio project on github</span></a>
            <div class="clear"></div>
        </article>
